...
$url        = 'http://staruml.io/download/releases/StarUML%20Setup%203.0.0.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'staruml3' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
